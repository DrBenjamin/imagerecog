...
class MyFrame(wx.Frame):
    def __init__(self, parent, title, size, config):
        ...
        self.on_remove_bucket = types.MethodType(on_remove_bucket, self)  # Binding remove bucket method
        ...
        from src.files import on_delete_file
        ...
        # Adding remove bucket menu item
